...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  const sendPhoneCode = async (phone: string): Promise<boolean> => {
    try {
      ...
      const response = await fetch('http://localhost:3001/api/auth/send-phone-code', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const verifyPhoneCode = async (phone: string, code: string): Promise<boolean> => {
    try {
      ...
      const response = await fetch('http://localhost:3001/api/auth/verify-phone-code', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const forgotPasswordPhone = async (phone: string): Promise<boolean> => {
    try {
      ...
      const response = await fetch('http://localhost:3001/api/auth/forgot-password-phone', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const resetPasswordPhone = async (phone: string, code: string, newPassword: string): Promise<boolean> => {
    try {
      ...
      const response = await fetch('http://localhost:3001/api/auth/reset-password-phone', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
